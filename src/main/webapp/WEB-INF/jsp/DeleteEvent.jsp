...
<body>
	...
	<p class="sign" align="center">Delete Event</p>
	<div class="main">
		<div align="center">
			<p class="success-message">${Success}</p>
		</div>
		<form:form method="post" action="/TicketBooking/deleteEventInDb"
			...
			<form:input class="un " path="gameEventName" type="text" readonly="true"
				align="center" placeholder="Event Name" id="gameEventName" />
			<br>
			<label for="showDate">show date </label>
			<form:input class="un " path="showDate" type="text" align="center" readonly="true"
				placeholder="show Date" id="showDate" />
			<br>
			<label for="numberOfSeats">Number of Seats </label>
			<form:input class="un " path="numberOfSeats" type="text" readonly="true"
				align="center" placeholder="Number of Seats" id="numberOfSeats" />
			<br>
			<label for="showStatus">Event Status </label>
			<form:input class="un " path="showStatus" type="text" readonly="true"
				align="center" placeholder="Show Status" id="showStatus" />
			<br>
			<div align="center">
