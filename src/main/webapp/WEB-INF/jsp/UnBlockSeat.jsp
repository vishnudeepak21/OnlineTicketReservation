...
<body>
	...
	<div class="main">
		...
		<form:form method="post" action="/TicketBooking/userUnblockSeat"
			modelAttribute="eventSeatBlockDtl">
			<label for="gameEventId">Game Event Id </label>
			<form:input path="gameEventId" readonly="true" class="un "
				type="text" align="center" placeholder="Event Id" id="gameEventId" />


			<label for="userId">User Id </label>
			<form:input path="userId" class="un " type="text" align="center"
				readonly="true" placeholder="User Id" id="user Id" />


			<label for="userName">User Name </label>
			<form:input path="userName" class="un " type="text" align="center"
				readonly="true" placeholder="User Name" id="user Name" />
			...
			<form:input path="numberOfSeats" class="un " type="text"
				readonly="true" align="center" placeholder="number of seats"
				id="numberOfSeats" />

			<label for="totalSeatBooked">Number of Booked Seats</label>
			<form:input path="totalSeatBooked" class="un " type="text"
				readonly="true" align="center" placeholder="number of seats Booked"
				id="totalSeatBooked" />

			<label for="cancelledSeatCount">Number of Seats cancelled</label>
			<form:input path="cancelledSeatCount" class="un " type="text"
				readonly="true" align="center"
				placeholder="number of seats cancelled" id="cancelledSeatCount" />

			<label for="actualCancelledSeatCount">Number of Seats to be
				cancelled</label>
			<form:input path="actualCancelledSeatCount" class="un " type="text"
				align="center" placeholder="number of seats needs to be cancelled"
				id="actualCancelledSeatCount" />
			...
			<a class="forgot" style="margin-left: 20px"
				href="/TicketBooking/userhome">Previous</a>
