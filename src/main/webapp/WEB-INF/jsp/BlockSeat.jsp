...
<body>
	...
	<p class="sign" align="center">Block Seat - Event</p>
	<div class="main">
		<div align="center">
		...
		<form:form method="post" action="/TicketBooking/userBlockSeat"
			...
			<form:input path="userId" class="un " type="text" align="center"
				readonly="true" placeholder="User Id" id="userId" />


			<label for="userName">User Name </label>
			<form:input path="userName" class="un " type="text" align="center"
				readonly="true" placeholder="User Name" id="userName" />
			...
			<label for="actualSeatBooked">Actual Seat Booked</label>
			<form:input path="actualSeatBooked" class="un " type="text"
				align="center" placeholder="seats needed for booking"
				id="actualSeatBooked" />
